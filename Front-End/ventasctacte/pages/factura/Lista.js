                                    ...
                                    facturas.map(factura => {
                                        return (
                                            <tr key={factura.id}>
                                                ...
                                                <td><button className='btn btn-info btn-sm'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye" viewBox="0 0 16 16" onClick={() => { router.push(`/factura/Detalles/${factura.id}`) }}>
