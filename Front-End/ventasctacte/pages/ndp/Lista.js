                                            ...
                                            notas.map(nota => {
                                                return (
                                                    <tr key={nota.id}>
                                                        ...
                                                        <td><button className='btn btn-info btn-sm' onClick={()=>{router.push(`/ndp/Detalles/${nota.id}`)}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye" viewBox="0 0 16 16" >
